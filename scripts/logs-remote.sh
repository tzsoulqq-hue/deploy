...
valid_service() {
  case "$1" in
    account-db|browser-reg|dashboard|gopay-app|gopay-payment|herosms-sms-service|orchestrator|outlook-imap-service|outlook-register-service|mailbox-api|otp-relay|temporal|postgres)
      return 0
      ;;
    *)
      return 1
